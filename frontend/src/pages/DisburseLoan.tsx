                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                                ...
                                <div style={{ display: "flex", gap: "10px" }}>
                                    <button onClick={() => printDoc("Voucher", buildVoucherBody())}
                                        style={{ flex: 1, padding: "13px 6px", border: "1.5px solid #c7d2fe", borderRadius: "14px", fontSize: "11px", fontWeight: 800, letterSpacing: "0.3px", cursor: "pointer", background: "linear-gradient(145deg, #eef2ff 0%, #dde3ff 100%)", color: "#4338ca", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "6px", minHeight: "72px", transition: "all 0.25s cubic-bezier(0.4,0,0.2,1)", boxShadow: "0 3px 10px rgba(99,102,241,0.16)" }}
                                    ...
                                    <button onClick={() => printDoc("Agreement", buildAgreementBody())}
                                        style={{ flex: 1, padding: "13px 6px", border: "1.5px solid #a7f3d0", borderRadius: "14px", fontSize: "11px", fontWeight: 800, letterSpacing: "0.3px", cursor: "pointer", background: "linear-gradient(145deg, #f0fdf4 0%, #ccfbe8 100%)", color: "#15803d", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "6px", minHeight: "72px", transition: "all 0.25s cubic-bezier(0.4,0,0.2,1)", boxShadow: "0 3px 10px rgba(16,185,129,0.16)" }}
                                    ...
                                    <button onClick={() => navigate(-1)}
                                        style={{ flex: 1, padding: "13px 6px", border: "1.5px solid #e2e8f0", borderRadius: "14px", fontSize: "11px", fontWeight: 800, letterSpacing: "0.3px", cursor: "pointer", background: "linear-gradient(145deg, #ffffff 0%, #f1f5f9 100%)", color: "#64748b", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "6px", minHeight: "72px", transition: "all 0.25s cubic-bezier(0.4,0,0.2,1)", boxShadow: "0 3px 10px rgba(100,116,139,0.12)" }}
                                    ...
                                    <button onClick={handleDisburse} disabled={!canDisburse || submitting}
                                        style={{ flex: 1.5, padding: "13px 6px", border: "none", borderRadius: "14px", fontSize: "11.5px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.8px", cursor: canDisburse ? "pointer" : "not-allowed", background: canDisburse ? "linear-gradient(145deg, #3b82f6 0%, #1d4ed8 100%)" : "linear-gradient(145deg, #e2e8f0 0%, #cbd5e1 100%)", color: canDisburse ? "white" : "#94a3b8", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "6px", minHeight: "72px", transition: "all 0.25s cubic-bezier(0.4,0,0.2,1)", boxShadow: canDisburse ? "0 6px 18px rgba(37,99,235,0.45)" : "none" }}
                                        ...
                                        <span style={{ fontSize: "18px", lineHeight: 1 }}>{submitting ? "⏳" : "💰"}</span>
