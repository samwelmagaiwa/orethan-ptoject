              ...
              <div className="form-section">
                ...
                <div style={{
                  ...
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    ...
                    <input type="text" name="kiasiMkopo" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.kiasiMkopo ? formatMoney(Number(form.kiasiMkopo)) : ""} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    <strong>Wastani wa kipato kwa mwezi</strong>
                    <input type="text" name="wastaniKipatoKwaMwezi" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.wastaniKipatoKwaMwezi ? formatMoney(Number(form.wastaniKipatoKwaMwezi)) : ""} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    <strong>Wastani wa matumizi kwa mwezi</strong>
                    <input type="text" name="wastaniMatumiziKwaMwezi" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.wastaniMatumiziKwaMwezi ? formatMoney(Number(form.wastaniMatumiziKwaMwezi)) : ""} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field">
                  ...
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    ...
                    <input type="text" name="mudaKulipaMkopo" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.mudaKulipaMkopo} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    <strong>Muda kwa tarakimu</strong>
                    <input type="text" name="kwaTarakimu" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.kwaTarakimu} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    ...
                    <input type="text" name="kiasiRejeshoBilaMatatizo" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.kiasiRejeshoBilaMatatizo ? formatMoney(Number(form.kiasiRejeshoBilaMatatizo)) : ""} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    <strong>Kiwango cha Riba (% kwa mwezi)</strong>
                    <input type="text" name="kiwakocha_Riba" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.kiwakocha_Riba ? `${form.kiwakocha_Riba}%` : ""} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    <strong>Aina ya Riba</strong>
                    <input type="text" name="ainaYaRiba" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.ainaYaRiba} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field" style={{ background: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px dashed #cbd5e1' }}>
                    <strong>Ada ya Uchakataji (%)</strong>
                    <input type="text" name="adaYaUchakataji" readOnly style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', fontWeight: 'bold' }} value={form.adaYaUchakataji ? `${form.adaYaUchakataji}%` : ""} />
                    <small style={{ color: '#94a3b8', fontSize: '0.7rem' }}>Tumia Calculator hapo juu</small>
                  </div>
                  <div className="grid-field">
