        ...
        <nav className="sd-nav">
          ...
          {canAccessApprovals && (
            <>
              ...
              {/* Manager Review — LM navigates to their customer list */}
              {canAccessManagerReview && (
                <div
                  className={`sd-item ${(isActive("/lm/customers") || (!canAccessGmReview && location.pathname.includes("/customers"))) ? "sd-item--active" : ""}`}
                  onClick={() => navigate(userRole === "loan_manager" ? "/lm/customers" : "/customers")}
              ...
              {/* LO Review — GM sees the loan officer customer list */}
              {canAccessGmReview && (
                <div
                  className={`sd-item ${(isActive("/gm/customers") || (canAccessGmReview && !isActive("/general-manager") && !isActive("/managing-director") && location.pathname.includes("/customers"))) ? "sd-item--active" : ""}`}
