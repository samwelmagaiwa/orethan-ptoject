...
Route::prefix('v1')->group(function () {
    ...
    // NextSMS delivery receipt webhook — public, no auth (NextSMS POSTs to this)
    Route::post('/sms/delivery-receipt', [SmsLogController::class, 'deliveryReceipt']);
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // ROUTE YA KUREKEBISHA KIASI (GM/MD ADJUST)
        Route::patch('/loans/{id}/adjust', [LoanController::class, 'adjust']);
